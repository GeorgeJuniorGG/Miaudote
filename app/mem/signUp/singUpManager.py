...
class SignUpManager:
    ...
    def singUpScreenManager(self):
        ...
        if(userData):
            self.currentUser = self.authService.signUp(self.signUpScreen.ids.password1.text,self.signUpScreen.ids.password2.text, self.signUpScreen.ids.minimumAge.text,self.signUpScreen.ids._check.active, userData)
    ...
    def singUpScreen2aManager(self):
        ...
        if(userAddress and FirebaseDB.storeAddress('adopters',self.currentUser, userAddress)):
    ...
    def singUpScreen2bManager(self):
        ...
        if(userAddress and FirebaseDB.storeAddress('protectors', self.currentUser, userAddress)):
    ...
    def singUpScreen3Manager(self):
        ...
        if(userPreferences and FirebaseDB.storePreferences(self.currentUser, userPreferences)):
    ...
    def singUpScreen4Manager(self):
        ...
        if(userHomeCharacteristics and FirebaseDB.storeHomeCharacteristics(self.currentUser, userHomeCharacteristics)):
